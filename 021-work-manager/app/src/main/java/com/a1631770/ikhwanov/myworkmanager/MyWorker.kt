...
class MyWorker(context: Context, workerParameters: WorkerParameters) : Worker(context, workerParameters) {
    ...
    companion object {
        ...
        const val APP_ID = "a24c261edb26f53991dcb9bd6224dacb"
        const val EXTRA_CITY = "Banjarmasin"
            ...
            override fun onSuccess(
                ...
                try {
                    ...
                    val currentWeather: String =
                        responObject.getJSONArray("weather").getJSONObject(0).getString("main")
                    val desc = responObject.getJSONArray("weather").getJSONObject(0)
