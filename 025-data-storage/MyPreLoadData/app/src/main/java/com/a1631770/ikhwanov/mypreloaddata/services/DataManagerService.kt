package com.a1631770.ikhwanov.mypreloaddata.services
...
import com.a1631770.ikhwanov.mypreloaddata.R
...
import com.a1631770.ikhwanov.mypreloaddata.pref.AppPreferences
...
class DataManagerService : Service(), CoroutineScope {
    ...
    */
    ...
    private fun getData(): Boolean {
        ...
        val appPreference = AppPreferences(applicationContext)
    ...
    private fun preLoadRaw(): ArrayList<MahasiswaModel> {
        ...
        try {
            val rawText = resources.openRawResource(R.raw.data_mahasiswwa)
